...
First you want to find out what vars are available to you in your classpath.

FIXME: write usage documentation!

Invoke a library API function from the command-line:

    $ clojure -X instrumentation-clj.instrumentation-clj/foo :a 1 :b '"two"'
...
Your library will be deployed to net.clojars.instrumentation-clj/instrumentation-clj on clojars.org by default.
